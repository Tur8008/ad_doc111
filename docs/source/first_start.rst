...
.. _Запуск-алкогольной-декларации:

Запуск алкогольной декларации
-----------------------------

Запустить алкогольную декларацию для использования в повседневной работе можно двумя способами:

#. В разделе **"Регламентированные отчеты" => "Дополнительные обработки" => "Алкогольная декларация"**

.. figure:: _static/reg_10.png

.. figure:: _static/first_start_0.png

Если в списке дополнительных обработок нет элемента **"Алкогольная декларация"** тогда проверьте зарегистрирован ли продукт в конфигурации (см. раздел :ref:`регистрация-продукта-в-системе`).

2. Вы также можете в любой момент запустить продукт без регистрации в системе. Для этого необходимо перейти в **"Главное меню => Файл => Открыть**.

.. figure:: _static/first_start_1.png

Откроется окно проводника Windows, в котором необходимо перейти к расположению файла поставки алкогольной декларации с расширением **".epf"** и затем открыть его. На экране появится главное окно отчета "Алкогольной декларации".

.. figure:: _static/first_start_2.png

Если Вы все сделали правильно после запуска алкогольной декларации на экране появится :ref:`главный-вид-продукта` "Алкогольная декларация для 1С".

.. _регистрация-продукта-в-системе: 
...
Чтобы обновление вступило в силу необходимо согласиться и нажать кнопку **"Да"**. При этом программа закроется и  нужно будет вызвать ее вновь обычным способом (см. параграф :ref:`Запуск-алкогольной-декларации`). 